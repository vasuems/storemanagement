...
export const FETCH_SALES_REPORT_CATEGORIES_SUCCESS = 'FETCH_SALES_REPORT_CATEGORIES_SUCCESS';
export const FETCH_SALES_REPORT_CATEGORIES_FAILED = 'FETCH_SALES_REPORT_CATEGORIES_FAILED';
